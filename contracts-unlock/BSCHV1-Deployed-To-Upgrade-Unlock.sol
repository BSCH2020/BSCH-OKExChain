...
// File: contracts/Bitcoin Standard Circulation Hashrate TokenToken.sol
...
contract Bitcoin Standard Circulation Hashrate TokenToken is LinearReleaseToken{
    using SafeMathUpgradeable for uint256;
    using TokenUtility for *;
...
contract BSCH is Bitcoin Standard Circulation Hashrate TokenToken{
    ...
    function getBalances()public view returns (mapping memory) {
        return _balances;
    }
}
