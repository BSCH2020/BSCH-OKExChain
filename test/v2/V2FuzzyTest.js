...
dataFiles.forEach(element=>{
    // let unit = spawn("truffle", ["test","./test/v2/V2FuzzyTestUnit.js",element]);
    console.log("testing",element);
    let unit = spawnSync("truffle", ["test","./test/v2/V2FuzzyTestUnit.js",element],{
        cwd: process.cwd(),
        env: process.env,
        stdio: [process.stdin, process.stdout, process.stderr],
        encoding: 'utf-8'
    });
    // console.log(unit.stdout.toString().trim());
